...
function changebg() {
  ...
  var navbar = document.getElementsByClassName("nave")[0];
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function toggleMenuIcon() {
      if (navBar.classList.contains('active')) {
          ...
          menuIcon.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5"/></svg>';
      }
  }
});
//For footer
...
document.addEventListener('DOMContentLoaded', () => {
  const carouselInner = document.querySelector('.favorbottom');
  const items = document.querySelectorAll('.favor');
  let currentIndex = 0;

  function showSlide(index) {
    if (items.length > 0) {
      const offset = -index * 100 / items.length; 
